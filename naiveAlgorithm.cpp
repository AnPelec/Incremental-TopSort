...
NaiveAlgorithm::NaiveAlgorithm(size_t _n, size_t _m)
: L(_n, 0), adj(_n, vs()) {
    n = _n;
    m = _m;
}

bool NaiveAlgorithm::update_label(size_t u, size_t original_vertex) {
...
bool NaiveAlgorithm::insert_edge(size_t u, size_t v) {
...
bool NaiveAlgorithm::precedes(size_t u, size_t v) {
    return L[u] < L[v];
}

std::vector < size_t > NaiveAlgorithm::topsort() {
